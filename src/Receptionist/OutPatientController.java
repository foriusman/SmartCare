 ...
 * @author -USER
 */
public class OutPatientController implements Initializable {
   ...
   public String paitentType="Out-Patient";
    /**
    ...
    public  void viewPatientTable(){
            ...
            String sql ="select * from patient where paitentType='"+paitentType+"'";
   ...
   try{
    ...
    private void getSearchResult(ActionEvent event) {
        String searchKey = searchBar.getText();
         ...
         String sql ="select * from patient where paitentID='"+searchKey+"' AND paitentType='"+paitentType+"'";
